<template>
  <div>
    ...
    <div class="front-header">
      <div class="front-header-left" @click="navToHome()">
        <img src="@/assets/imgs/logo.png" alt="">
        <div class="title">购物平台</div>
      </div>
      <div class="front-header-center">
        <div class="front-header-center" style="text-align: right">
          <el-input style="width: 300px" placeholder="请输入商品名称" v-model="name"></el-input>
        ...
        <div v-else>
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <div style="text-decoration: none" @click="navToPerson">个人中心</div>
              </el-dropdown-item>
              <el-dropdown-item>
